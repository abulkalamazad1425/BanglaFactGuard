...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_credibility_scores_created_at"),
        "credibility_scores",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_credibility_scores_user_id"),
        "credibility_scores",
        ["user_id"],
        unique=True,
    )
    op.create_table(
        ...
        sa.Column(
            ...
            nullable=True,
            comment="Deep-link to the relevant result page",
        ),
    ...
    op.create_index(
        op.f("ix_expert_reviews_claim_id"), "expert_reviews", ["claim_id"], unique=False
    )
    op.create_index(
        op.f("ix_expert_reviews_created_at"),
        "expert_reviews",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_expert_reviews_reviewer_id"),
        "expert_reviews",
        ["reviewer_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(length=50),
            nullable=False,
            comment="agree | disagree | unclear | other",
        ),
    ...
    op.create_index(
        op.f("ix_user_feedback_claim_id"), "user_feedback", ["claim_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_verified_claims_submitter_id"),
        "verified_claims",
        ["submitter_id"],
        unique=False,
    )
    op.create_foreign_key(
        None, "verified_claims", "users", ["submitter_id"], ["id"], ondelete="SET NULL"
    )
    op.alter_column(
        "verified_sources",
        "body_selectors",
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_credibility_scores_user_id"), table_name="credibility_scores"
    )
    op.drop_index(
        op.f("ix_credibility_scores_created_at"), table_name="credibility_scores"
    )
